...
module.exports = class QueueCommand extends Command {
    ...
    run(msg, { page }) {
        ...
        const paginated = util.paginate(queue.songs, page, Math.floor(this.client.config.defaultSettings.paginatedItems));
        ...
        return msg.embed({
            ...
            description: stripIndents`
				__**Song queue, page ${paginated.page}** (${queue.songs.length} songs, ${paginated.maxPage} pages)__ 
